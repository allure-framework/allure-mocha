...
* `allure.createAttachement(name, content, [type])` – save attachment to test. If you're calling this inside step function, attachment will be saved to step function.
